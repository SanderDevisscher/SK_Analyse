...
### Net verhoogd of niet
#### Larven

|                 |Succesvolle vangsten*|Grootste vangst   |Gemiddelde vangst  |
|-----------------|:-------------------:|:----------------:|:-----------------:|
|Net verhoogd     | `r nv_larven$n`     |`r nv_larven$max` |`r nv_larven$mean` |
|Net Niet verhoogd| `r nnv_larven$n`    |`r nnv_larven$max`|`r nnv_larven$mean`|

#### Metamorfen

|                 |Succesvolle vangsten*|Grootste vangst   |Gemiddelde vangst  |
|-----------------|:-------------------:|:----------------:|:-----------------:|
|Net verhoogd     | `r nv_metamorf$n`     |`r nv_metamorf$max` |`r nv_metamorf$mean` |
|Net Niet verhoogd| `r nnv_metamorf$n`    |`r nnv_metamorf$max`|`r nnv_metamorf$mean`|

#### Adulten

|                 |Succesvolle vangsten*|Grootste vangst   |Gemiddelde vangst  |
|-----------------|:-------------------:|:----------------:|:-----------------:|
|Net verhoogd     | `r nv_adult$n`     |`r nv_adult$max` |`r nv_adult$mean` |
|Net Niet verhoogd| `r nnv_adult$n`    |`r nnv_adult$max`|`r nnv_adult$mean`|

```{r tabel per hoek, include=FALSE}
#n_00 <- (hoeken_data_compiled$hoek == "00°")
```
...
|                 |Succesvolle vangsten*|Grootste vangst   |Gemiddelde vangst  |
|-----------------|:-------------------:|:----------------:|:-----------------:|
|00°              |   `r n_larven`      |`r max_larven`    |`r mean_metamorfen`|
|45°              | `r n_metamorfen`    |`r max_metamorfen`|`r mean_larven`    |
|90°              | `r n_metamorfen`    |`r max_metamorfen`|`r mean_larven`    |
