...
temp$Datum <- ifelse(temp$Tijdstempel == "22-6-2017 21:47:39", "20-06-2017", temp$Datum)
temp$Datum <- ifelse(temp$Tijdstempel == "9-10-2017 22:46:06", "27-09-2017", temp$Datum)
temp$Datum <- ifelse(temp$Tijdstempel == "24-8-2018 12:32:26", "14-8-2018", temp$Datum)
...
temp <- Records_met_datums %>% 
  mutate(Datum = case_when(Tijdstempel == "24-8-2018 12:24:04" ~ "11-08-2018",
                           TRUE ~ Datum)) %>%
  filter(!Tijdstempel %in% c("17-1-2019 21:07:00", "3-9-2018 12:58:51", "3-9-2018 13:24:29", "17-1-2019 22:02:05"))
...
verschil2 <- base::setequal(Records_met_datums, data_offline)
