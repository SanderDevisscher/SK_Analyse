...
Recorder_Plaatsen %>% select(-X, -Y, -`Net verhoogd?`, -contains("L00"), -contains("L0"), -contains("L1"), -contains("L2"), -contains("M1"), -contains("M2"), -contains("AM"), -contains("AV"), -contains("Bijvangst"), -contains("Opmerkingen")) -> temp
