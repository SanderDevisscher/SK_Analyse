...
if(file.exists(filename)){
  ...
  write_csv(backup, filename2)
}

Recorder_Afvangsten_Nieuw <- subset(Recorder_Afvangsten_Merged2, !(Tijdstempel %in% backup$Tijdstempel))

print(nrow(Recorder_Afvangsten_Nieuw))

write_csv(Recorder_Afvangsten_Nieuw, filename)
...
Recorder_Plaatsen %>% select(-X, -Y, -`Net verhoogd?`, -contains("L00"), -contains("L0"), -contains("L1"), -contains("L2"), -contains("M1"), -contains("M2"), -contains("AM"), -contains("AV"), -contains("Bijvangst"), -contains("Opmerkingen"), -contains("Meer")) -> temp
