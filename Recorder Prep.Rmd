...
temp5 <- temp4 %>% 
  ...
  spread(key = Measurement_Qualifier, value = Aantal, fill = 0)
...
Recorder_Afvangsten_New <- anti_join(Recorder_Afvangsten_Merged_Comment, Recorder_Old_Prepped, by=c("Datum" = "Sample_Date"))
...
Recorder_Plaatsen %>% 
  select(-X, -Y, -`Net verhoogd?`, -contains("L00"), -contains("L0"), -contains("L1"), -contains("L2"),    -contains("M1"), -contains("M2"), -contains("AM"), -contains("AV"), -contains("Bijvangst"),             -contains("Opmerkingen"), -contains("Meer")) -> Recorder_Plaatsen_Redux
